  ...
  return (
    <div>
      ...
      <div className={styles.affair__filter__btn__wrapper}>
        <SuperButton className={styles.affair__filter_btn} onClick={setAll}>
          All
        </SuperButton>
        <SuperButton className={styles.affair__filter_btn} onClick={setHigh}>
          High
        </SuperButton>
        <SuperButton className={styles.affair__filter_btn} onClick={setMiddle}>
          Middle
        </SuperButton>
        <SuperButton className={styles.affair__filter_btn} onClick={setLow}>
          Low
        </SuperButton>
      </div>
    </div>
