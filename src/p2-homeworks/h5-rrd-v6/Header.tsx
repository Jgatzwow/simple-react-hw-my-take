...
function Header() {
    ...
    const animatedNavClassName = !toggle ? s.nav__links__closed : s.nav__links__opened
    ...
    return (
        <nav className={s.navbar__wrapper}>
             <div onMouseEnter={onBurgerMouseLeaveHandler} onMouseOver={onBurgerMouseOverHandler}
                       onClick={onBurgerClickHandler} className={animatedBurgerClassName}>
